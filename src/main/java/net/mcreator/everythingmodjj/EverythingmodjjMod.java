 ...
 *
 */
package net.mcreator.everythingmodjj;
...
@Mod("everythingmodjj")
public class EverythingmodjjMod {
	public static final Logger LOGGER = LogManager.getLogger(EverythingmodjjMod.class);
	public static final String MODID = "everythingmodjj";
